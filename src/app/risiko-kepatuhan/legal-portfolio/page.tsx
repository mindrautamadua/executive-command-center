    ...
    <div className="flex h-screen min-w-[1440px] overflow-hidden bg-[var(--bg-app)]">
      ...
      <main className="scroll-thin min-w-0 flex-1 overflow-y-auto">
        ...
        <div className="flex flex-col gap-3 px-5 pb-5">
          ...
          <div className="grid h-[250px] grid-cols-[minmax(0,33fr)_minmax(0,67fr)] grid-rows-[minmax(0,1fr)] gap-3">
            <LegalCaseByType />
            <ExposureByCase />
          </div>

          <div className="grid h-[240px] grid-cols-[minmax(0,34fr)_minmax(0,34fr)_minmax(0,32fr)] grid-rows-[minmax(0,1fr)] gap-3">
            <CaseStageFunnel />
            <GeoConcentration />
            <OkupasiLahan />
          </div>
