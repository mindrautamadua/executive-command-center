...
/** Header standar untuk seluruh halaman detail kartu Talent Intelligence. */
export function TiDetailHeader({
  icon,
  title,
  subtitle,
  stat,
  ...
  title: string;
  subtitle: string;
  /** Angka utama di secondary bar, mis. "3.742 talenta aktif". */
  stat: string;
  /** Bagian setelah "Talent Intelligence /" pada breadcrumb. */
  breadcrumb: string;
}) {
  return (
    <ModuleHeader
      ...
      secondaryLeft={
        <span className="flex items-center gap-2 text-[9.5px] text-ink-500">
          ...
          Talent Intelligence / {breadcrumb} · Sumber: Talent Management System &amp; HRIS konsolidasi · Data per 31 Mei 2026
        </span>
      }
