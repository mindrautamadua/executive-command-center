...
const SIGNAL_TONE: Record<TiExecSignal["tone"], { wrap: string; dot: string; impact: string }> = {
  red: {
...
/** Lapisan sintesis eksekutif: sinyal kritis lintas widget talent + satu rekomendasi utama. */
export function ExecutiveTalentIntelligence() {
  return (
