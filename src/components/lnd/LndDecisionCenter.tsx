...
import { lndDecisions, type LndDecision } from "@/lib/lnd-data";
...
/**
 * BOD Learning Decision Center: kapabilitas yang sudah sampai titik
 * keputusan — capability risk, succession gap, dan constraint transfer.
 */
export function LndDecisionCenter() {
  return (
    <div
      className="card anim-rise px-4 pb-3.5 pt-3"
      style={{ "--d": "760ms" } as React.CSSProperties}
    >
      <SectionHead title="BOD Learning & Capability Decision Center" />
