...
import { distribusiKompetensi } from "@/lib/lnd-data";
...
export function DistribusiKompetensi() {
  ...
  return (
    ...
    >
      <h3 className="card-title-navy">Distribusi Jam Pelatihan Berdasarkan Kompetensi</h3>
        ...
        <div className="ml-2 flex flex-1 flex-col gap-[7px]">
          {distribusiKompetensi.map((d, i) => (
            ...
            >
              ...
              />
              <span className="w-[62px] text-[9.5px] text-ink-700">{d.name}</span>
