...
import { korporasiInsights } from "@/lib/hkm-data-detail";

/** Insight & rekomendasi halaman Korporasi & Anak Usaha. */
export function KorporasiInsight() {
  return (
    <div
