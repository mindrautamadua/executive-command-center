...
import type { HkmInsight } from "@/lib/hkm-data";

/**
 * Kartu Insight & Rekomendasi dimensi Hukum (mirror EsgInsightGrid) — tiap
 * item memasangkan temuan dengan aksi lanjutannya.
 */
export function HkmInsightGrid({ items, cols }: { items: HkmInsight[]; cols: string }) {
  return (
    <div
