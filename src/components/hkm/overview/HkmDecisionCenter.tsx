...
import { hkmDecisions } from "@/lib/hkm-data";
...
const TABS = [
  { label: "Perlu Keputusan", count: hkmDecisions.length },
  { label: "Dalam Proses", count: 0 },
];

/** BOD Decision Center dimensi Hukum (clone BodDecisionCenter). */
export function HkmDecisionCenter() {
