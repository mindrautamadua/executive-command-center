...
import { litigasiInsights } from "@/lib/hkm-data-detail";

/** Insight & rekomendasi halaman Litigasi & Advokasi. */
export function LitigasiInsight() {
  return (
    <div
