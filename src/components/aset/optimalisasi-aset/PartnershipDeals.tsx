  ...
  return (
    ...
    >
      ...
      <p className="mt-[3px] text-[9px] text-ink-500">
        {PARTNERSHIP_DEALS_AKTIF} Kontrak Aktif · Rp {rp(PARTNERSHIP_NILAI_TOTAL_RP_M)} M · Top 5 Rp{" "}
        {rp(PARTNERSHIP_TOP5_NILAI_RP_M)} M (Pendapatan YTD Rp {rp(PARTNERSHIP_TOP5_PENDAPATAN_RP_M)}{" "}
        M)
      </p>

      <div className="scroll-thin mt-2 flex min-h-0 flex-1 flex-col gap-1.5 overflow-y-auto pr-1">
        {partnershipDeals.map((d) => (
