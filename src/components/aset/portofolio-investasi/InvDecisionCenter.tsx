...
/** BOD Decision Center portofolio investasi: Rp 4,7 T proposal menunggu keputusan. */
export function InvDecisionCenter() {
    ...
    >
      ...
      <p className="mt-[3px] text-[9px] text-ink-500">
        ...
        <span className="font-bold text-ink-900">
          Rp {INV_DECISION_TOTAL_RP_T.toLocaleString("id-ID", { minimumFractionDigits: 1 })} T
        </span>{" "}
        pada {INV_DECISION_PROYEK} Proyek
      </p>
