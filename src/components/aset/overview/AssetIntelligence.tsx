...
const SIGNAL_TONE = {
  ...
  amber: { wrap: "border-[#f3e3c3] bg-[#fdf9f0]", dot: "bg-[#f5a524]", impact: "text-[#d98b06]" },
  green: { wrap: "border-[#d6ecdf] bg-[#f4faf6]", dot: "bg-ptpn-green", impact: "text-ptpn-green" },
} as const;
...
/** Sintesis eksekutif dimensi aset: sinyal kritis + satu rekomendasi utama. */
