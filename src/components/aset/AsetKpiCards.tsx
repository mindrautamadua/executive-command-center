import { Banknote, Factory, Map, ScrollText, ShieldAlert, TrendingUp } from "lucide-react";
...
/** Renderer KPI strip dimensi Aset & Investasi (mirror EsgKpiCards). */
export function AsetKpiCards({ items, cols }: { items: AstKpi[]; cols: string }) {
  return (
        ...
        return (
          ...
          >
            ...
            <div className="mt-2 flex h-[13px] items-center gap-1.5">
              ...
              <span className="truncate text-[8.5px] text-ink-400" title={k.compare}>
                {k.compare}
              </span>
            </div>
          </div>
