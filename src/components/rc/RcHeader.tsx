...
import { Bell, CalendarDays, ChevronDown, Download, Scale } from "lucide-react";
        ...
        <div className="flex min-w-0 shrink-0 items-center gap-2.5">
          ...
          <div className="min-w-0">
            ...
            <p className="mt-[5px] text-[10.5px] font-semibold text-ink-500">
              Memantau kepatuhan regulasi ketenagakerjaan, temuan audit, dan kasus pelanggaran di
              seluruh grup
            </p>
          </div>
        </div>
