...
import { dekarbDecisions } from "@/lib/esg-data";
import { SectionHead } from "@/components/hc/SectionHead";
import { ScopeNote } from "@/components/ui/ScopeNote";

const TABS = [
  { label: "Perlu Keputusan", count: dekarbDecisions.length },
  { label: "Dalam Proses", count: 3 },
  { label: "Selesai", count: 6 },
];
...
export function DekarbDecisionCenter() {
    ...
    <div className="card anim-rise px-4 pb-3.5 pt-3" style={{ "--d": "200ms" } as React.CSSProperties}>
      ...
      <div className="mt-2.5 grid grid-cols-2 gap-2">
        {tab === 0 ? (
          ...
          <div className="col-span-2 rounded-xl border border-[#eef2f6] bg-[#f8fafc] px-3 py-4 text-center text-[9.5px] text-ink-500">
