import { ArrowRight, Leaf, Sparkles, TriangleAlert } from "lucide-react";
import { lhInsights } from "@/lib/esg-data-detail";

const ICONS = [TriangleAlert, Leaf];
