...
import { Bird, Droplets, Leaf, Recycle, TestTube2 } from "lucide-react";
import type { LucideIcon } from "lucide-react";
import { lhKpi } from "@/lib/esg-data-detail";
import type { EsgPageKpi } from "@/lib/esg-data";
import { Delta } from "@/components/ui/Delta";
import { useSubholding } from "@/components/SubholdingProvider";
import { ScopeNote } from "@/components/ui/ScopeNote";

const ICONS: LucideIcon[] = [Droplets, TestTube2, Recycle, Leaf, Bird];
              ...
              <div className="mt-2 flex items-center gap-1.5">
                {k.delta && k.trend ? (
                  <>
                    ...
                    <span className="truncate text-[8.5px] text-ink-400">vs FY 2025</span>
                  </>
                ) : (
