...
const TABS = [
  { label: "Perlu Keputusan", count: ratingDecisions.length },
  { label: "Dalam Proses", count: 3 },
  { label: "Selesai", count: 5 },
];

/** Decision Center rating & sustainable finance (pola BodDecisionCenter). */
export function RatingDecisionCenter() {
