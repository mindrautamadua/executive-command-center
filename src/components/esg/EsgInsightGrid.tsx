...
import type { EsgInsight } from "@/lib/esg-data";

/**
 * Kartu Insight & Rekomendasi dimensi ESG & Sustainability (mirror
 * MktInsightGrid) — tiap item memasangkan temuan dengan aksi lanjutannya.
 */
export function EsgInsightGrid({ items, cols }: { items: EsgInsight[]; cols: string }) {
  return (
    <div
