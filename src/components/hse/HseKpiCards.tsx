...
/** Item KPI halaman detail K3 & Keamanan: data dari hse-data + ikon lucide dari halaman. */
export type HseKpiCardItem = HsePageKpi & { icon: LucideIcon };
...
/** Renderer KPI strip halaman detail K3 & Keamanan (mirror TikKpiCards). */
export function HseKpiCards({ items, cols }: { items: HseKpiCardItem[]; cols: string }) {
  return (
