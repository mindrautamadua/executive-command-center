import { ArrowRight, Scale, ShieldAlert, Sparkles, TrendingUp } from "lucide-react";
import type { LucideIcon } from "lucide-react";
import { keamananInsights } from "@/lib/hse-data-detail";

const ICONS: LucideIcon[] = [ShieldAlert, TrendingUp, Scale, ShieldAlert];

const TONES: { bg: string; icon: string }[] = [
  { bg: "bg-[#fdecec]", icon: "text-[#ef4444]" },
  { bg: "bg-[#fdf3e0]", icon: "text-[#d98b06]" },
  { bg: "bg-[#e8f1fd]", icon: "text-[#2f6fe4]" },
  { bg: "bg-ptpn-greenLight", icon: "text-ptpn-green" },
];

export function KeamananInsight() {
  return (
    <div
