...
import { CircleAlert, MapPinned, PackageSearch, ShieldCheck, Users, Wallet } from "lucide-react";
import type { LucideIcon } from "lucide-react";
import { keamananKpi } from "@/lib/hse-data-detail";
import type { HsePageKpi } from "@/lib/hse-data";
import { Delta } from "@/components/ui/Delta";
import { useSubholding } from "@/components/SubholdingProvider";
import { ScopeNote } from "@/components/ui/ScopeNote";

const ICONS: LucideIcon[] = [PackageSearch, Wallet, Users, ShieldCheck, CircleAlert, MapPinned];

const TONES: Record<HsePageKpi["tone"], string> = {
...
/** Strip KPI halaman Keamanan Aset & Kebun (6 metrik inti). */
export function KeamananKpiStrip() {
              ...
              <div className="mt-2 flex items-center gap-1.5">
                {k.delta && k.trend ? (
                  <>
                    ...
                    <span className="truncate text-[8.5px] text-ink-400">vs YTD 2025</span>
                  </>
                ) : (
