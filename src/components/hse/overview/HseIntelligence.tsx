...
import { hseIntelligence } from "@/lib/hse-data";
...
/** Lapisan sintesis eksekutif K3: 3 sinyal lintas domain + rekomendasi utama. */
export function HseIntelligence() {
  return (
    <div className="card anim-rise px-4 pb-3.5 pt-3" style={{ "--d": "30ms" } as React.CSSProperties}>
      <div className="flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="flex items-baseline gap-1">
            <span className="text-[11px] font-extrabold leading-none text-[#d98b06]">2</span>
            <span className="text-[8.5px] font-semibold text-ink-500">Perhatian</span>
          </span>
          <span className="flex items-baseline gap-1">
            <span className="text-[11px] font-extrabold leading-none text-ptpn-green">0</span>
      ...
      <div className="mt-2.5 flex items-start gap-2 rounded-xl bg-ptpn-greenLight px-3 py-2.5">
        ...
        <p className="text-[9.5px] leading-[1.45] text-ink-900">
          ...
          Prioritas kuartal ini adalah menutup 7 rekomendasi investigasi fatal yang masih terbuka dan
          menyetujui uplift APD &amp; mekanisasi panen Rp 96 M — keduanya menyasar rantai panen–angkut
          TBS yang menyumbang 31 dari 84 kecelakaan; paralel, kesiapan karhutla Regional 3, 5, dan 6
          harus tuntas sebelum puncak kering Jul 2026.
        </p>
      </div>
    </div>
  );
