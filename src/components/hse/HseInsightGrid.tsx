...
import type { HseInsight } from "@/lib/hse-data";

/**
 * Kartu Insight & Rekomendasi dimensi K3 & Keamanan (mirror TikInsightGrid) —
 * tiap item memasangkan temuan dengan aksi lanjutannya.
 */
export function HseInsightGrid({ items, cols }: { items: HseInsight[]; cols: string }) {
  return (
    <div
