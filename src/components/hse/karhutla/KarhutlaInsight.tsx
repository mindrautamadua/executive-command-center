import { ArrowRight, Flame, Radar, Siren, Sparkles, TriangleAlert } from "lucide-react";
import type { LucideIcon } from "lucide-react";
import { karhutlaInsights } from "@/lib/hse-data-detail";

const ICONS: LucideIcon[] = [TriangleAlert, Siren, Radar, Flame];
...
export function KarhutlaInsight() {
  return (
    <div
