...
import { Flame, Map, Satellite, Timer, TowerControl, Users } from "lucide-react";
import type { LucideIcon } from "lucide-react";
import { karhutlaKpi } from "@/lib/hse-data-detail";
import type { HsePageKpi } from "@/lib/hse-data";
import { Delta } from "@/components/ui/Delta";
import { useSubholding } from "@/components/SubholdingProvider";
import { ScopeNote } from "@/components/ui/ScopeNote";

const ICONS: LucideIcon[] = [Satellite, Flame, Map, Timer, Users, TowerControl];
...
/** Strip KPI halaman Kebakaran Lahan & Tanggap Darurat (6 metrik inti). */
export function KarhutlaKpiStrip() {
