  ...
  return (
    <header className="flex items-center gap-4 border-b border-[#eef2f6] px-5 pb-3.5 pt-3.5">
      <div className="flex min-w-0 shrink-0 items-center gap-2.5">
        <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-[#e8f1fd] text-[#2f6fe4]">
        ...
        <div className="min-w-0">
          ...
          <p className="mt-[5px] text-[10.5px] font-semibold text-ink-500">
            Asisten cerdas Anda untuk semua kebutuhan Human Capital
          </p>
        </div>
      </div>

      <div className="ml-auto flex shrink-0 items-center gap-3">
        <button className="flex w-[130px] items-center justify-between rounded-lg border border-[#e3e9ef] bg-white px-3 py-1.5 text-left shadow-card">
          <span className="leading-tight">
            <span className="block text-[8.5px] font-medium text-ink-400">Mode</span>
            <span className="mt-[2px] block text-[11px] font-bold text-ink-900">Standard</span>
          </span>
        ...
        <div className="flex w-[210px] items-center gap-2 rounded-lg border border-[#e3e9ef] bg-white px-3 py-2 shadow-card">
          ...
          <span className="shrink-0 rounded border border-[#e3e9ef] bg-[#f8fafc] px-1 py-[1px] text-[8px] font-semibold text-ink-500">
            ⌘K
          </span>
        </div>
