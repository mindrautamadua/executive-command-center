...
import { pgdDecisions } from "@/lib/pgd-data";
...
const TABS = [
  { label: "Butuh Keputusan", count: pgdDecisions.length },
  { label: "Dalam Proses", count: 4 },
  { label: "Selesai", count: 7 },
];

/** Decision Center pengadaan (clone BodDecisionCenter) — 3 keputusan BOD prioritas. */
export function PgdDecisionCenter() {
