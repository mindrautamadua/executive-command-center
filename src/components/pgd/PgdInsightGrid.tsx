...
import type { PgdInsight } from "@/lib/pgd-data";
import { ScopeNote } from "@/components/ui/ScopeNote";

/**
 * Kartu Insight & Rekomendasi dimensi Pengadaan (mirror EsgInsightGrid) —
 * tiap item memasangkan temuan dengan aksi lanjutannya.
 */
export function PgdInsightGrid({ items, cols }: { items: PgdInsight[]; cols: string }) {
  return (
    <div
