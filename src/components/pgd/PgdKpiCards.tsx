...
import type { PgdPageKpi } from "@/lib/pgd-data";
import { Delta } from "../ui/Delta";
import { ScopeNote } from "@/components/ui/ScopeNote";

/** Item KPI halaman detail Pengadaan: data dari pgd-data + ikon lucide dari halaman. */
export type PgdKpiCardItem = PgdPageKpi & { icon: LucideIcon };

const TONES: Record<PgdPageKpi["tone"], string> = {
...
/** Renderer KPI strip halaman detail Pengadaan (mirror EsgKpiCards). */
export function PgdKpiCards({ items, cols }: { items: PgdKpiCardItem[]; cols: string }) {
  const grid = (
