...
/**
 * KPI stok. Tile yang terikat komoditas mengikuti filter subholding —
 * stok CPO → PalmCo, stok gula → SugarCo, stok karet → SupportingCo. Tile di
 * luar cakupan diredupkan (bukan dihapus) supaya posisi antar komoditas tetap
 * terbaca. Nilai total inventori adalah angka konsolidasi grup, ditandai
 * <ScopeNote />.
 */
