...
import type { DimInsight } from "@/lib/hilir-stok-margin-data";

const TONES: Record<DimInsight["tone"], { bg: string; icon: string; title: string }> = {
...
const ICONS: Record<DimInsight["tone"], typeof Info> = {
  green: CircleCheck,
  amber: CircleAlert,
  blue: Info,
  red: TriangleAlert,
...
/** Kartu Insight & Rekomendasi dimensi Pemasaran (mirror ProdInsightGrid). */
export function MktInsightGrid({ items, cols }: { items: DimInsight[]; cols: string }) {
  return (
    <div
