import { Calculator, Candy, Droplets, Gauge, Sprout, Trees } from "lucide-react";
import type { ProdKpi } from "@/lib/produksi-data";
import { Delta } from "../ui/Delta";

const ICONS: Record<ProdKpi["icon"], typeof Sprout> = {
  tbs: Sprout,
  cpo: Droplets,
  oer: Gauge,
  gula: Candy,
...
const TONES: Record<ProdKpi["tone"], string> = {
...
/** Renderer KPI strip dimensi Produksi (mirror WaKpiStrip) — grid via prop cols. */
export function ProdKpiCards({ items, cols }: { items: ProdKpi[]; cols: string }) {
  return (
