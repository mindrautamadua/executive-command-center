...
const ICONS: Record<ProdInsight["tone"], typeof Info> = {
  green: CircleCheck,
  amber: CircleAlert,
  blue: Info,
  red: TriangleAlert,
...
/** Kartu Insight & Rekomendasi dimensi Produksi (mirror InsightRekomendasi wa/). */
export function ProdInsightGrid({ items, cols }: { items: ProdInsight[]; cols: string }) {
  return (
    <div
