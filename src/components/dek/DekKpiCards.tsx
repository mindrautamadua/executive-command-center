...
import type { DekKpi } from "@/lib/dek-data";
import { Delta } from "../ui/Delta";

/** Item KPI halaman Dewan Komisaris: data dari dek-data + ikon lucide dari halaman. */
export type DekKpiCardItem = DekKpi & { icon: LucideIcon };

const TONES: Record<DekKpi["tone"], string> = {
...
/** Renderer KPI strip dimensi Dewan Komisaris (mirror TikKpiCards). */
export function DekKpiCards({ items, cols }: { items: DekKpiCardItem[]; cols: string }) {
  return (
