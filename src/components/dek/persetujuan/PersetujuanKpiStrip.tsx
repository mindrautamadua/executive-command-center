...
import { persetujuanKpi } from "@/lib/dek-data-detail";
import type { DekTone } from "@/lib/dek-data";
import { useSubholding } from "@/components/SubholdingProvider";
import { ScopeNote } from "@/components/ui/ScopeNote";

const ICONS: LucideIcon[] = [Inbox, CheckCircle2, Hourglass, Undo2, Clock3];
...
/** Strip 5 KPI antrean permohonan persetujuan Dewan Komisaris. */
export function PersetujuanKpiStrip() {
              ...
              <div className="mt-2 flex items-center gap-1.5">
                {k.delta && k.trend ? (
                  <>
                    ...
                    <span className="truncate text-[8.5px] text-ink-400">vs periode sama 2025</span>
                  </>
                ) : (
