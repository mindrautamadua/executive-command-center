import { ArrowRight, ClipboardList, Clock3, Scale, Split, Sparkles } from "lucide-react";
import { persetujuanInsights } from "@/lib/dek-data-detail";

const STYLES = [
  { bg: "bg-[#fdf3e0]", icon: "text-[#d98b06]", title: "text-[#d98b06]", Icon: Clock3 },
  { bg: "bg-[#e8f1fd]", icon: "text-[#2f6fe4]", title: "text-[#2f6fe4]", Icon: Split },
  { bg: "bg-[#fdecec]", icon: "text-[#ef4444]", title: "text-[#ef4444]", Icon: Scale },
  {
...
/** Insight & tindak pengawasan halaman Persetujuan & Kewenangan. */
export function PersetujuanInsight() {
  return (
    <div
