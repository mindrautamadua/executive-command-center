import { ArrowRight, Eye, ScanSearch, ShieldQuestion, Sparkles, Users } from "lucide-react";
import { komiteInsights } from "@/lib/dek-data-detail";

const STYLES = [
  { bg: "bg-ptpn-greenLight", icon: "text-ptpn-green", title: "text-ptpn-green", Icon: Eye },
  { bg: "bg-[#fdf3e0]", icon: "text-[#d98b06]", title: "text-[#d98b06]", Icon: ShieldQuestion },
  { bg: "bg-[#e8f1fd]", icon: "text-[#2f6fe4]", title: "text-[#2f6fe4]", Icon: Users },
  { bg: "bg-[#e6f6f5]", icon: "text-[#0d9488]", title: "text-[#0d9488]", Icon: ScanSearch },
];

/** Insight & tindak pengawasan halaman Komite Dewan Komisaris. */
export function KomiteInsight() {
  return (
    <div
