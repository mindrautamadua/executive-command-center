...
const ICONS: Record<StgInsight["tone"], typeof Info> = {
  good: CircleCheck,
  warn: CircleAlert,
  info: Info,
  bad: TriangleAlert,
...
/** Kartu Insight & Rekomendasi dimensi Strategi & Kinerja (mirror MktInsightGrid). */
export function StgInsightGrid({ items, cols }: { items: StgInsight[]; cols: string }) {
  return (
    <div
