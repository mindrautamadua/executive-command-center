...
import { tikIntelligence } from "@/lib/tik-data";
...
/** Lapisan sintesis eksekutif TI: 3 sinyal lintas domain + rekomendasi utama. */
export function TikIntelligence() {
  return (
    <div className="card anim-rise px-4 pb-3.5 pt-3" style={{ "--d": "30ms" } as React.CSSProperties}>
      ...
      <div className="mt-2.5 flex items-start gap-2 rounded-xl bg-ptpn-greenLight px-3 py-2.5">
        ...
        <p className="text-[9.5px] leading-[1.45] text-ink-900">
          ...
          Dua keputusan menentukan kuartal ini — uplift anggaran keamanan siber Rp 65 M untuk menutup
          limit breach patch SLA 78% vs ≥95%, dan go/no-go rollout modul kebun gelombang Q3 yang
          menahan benefit ERP Rp 1,17 T.
        </p>
      </div>
    </div>
  );
