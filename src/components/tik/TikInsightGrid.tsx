...
import type { TikInsight } from "@/lib/tik-data";

/**
 * Kartu Insight & Rekomendasi dimensi Teknologi Informasi (mirror
 * EsgInsightGrid) — tiap item memasangkan temuan dengan aksi lanjutannya.
 */
export function TikInsightGrid({ items, cols }: { items: TikInsight[]; cols: string }) {
  return (
    <div
