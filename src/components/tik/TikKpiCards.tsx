...
import type { TikPageKpi } from "@/lib/tik-data";
import { Delta } from "../ui/Delta";

/** Item KPI halaman detail TIK: data dari tik-data + ikon lucide dari halaman. */
export type TikKpiCardItem = TikPageKpi & { icon: LucideIcon };

const TONES: Record<TikPageKpi["tone"], string> = {
...
/** Renderer KPI strip halaman detail Teknologi Informasi (mirror EsgKpiCards). */
export function TikKpiCards({ items, cols }: { items: TikKpiCardItem[]; cols: string }) {
  return (
