import { ArrowRight, ClipboardCheck, Sparkles, TrendingUp, TriangleAlert } from "lucide-react";
import { kbaInsights } from "@/lib/kba-data";

const STYLES = [
  { bg: "bg-[#e8f1fd]", icon: "text-[#2f6fe4]", Icon: ClipboardCheck },
  { bg: "bg-[#fdecec]", icon: "text-[#ef4444]", Icon: TriangleAlert },
  { bg: "bg-ptpn-greenLight", icon: "text-ptpn-green", Icon: TrendingUp },
];

export function KbaInsight() {
  return (
    <div
