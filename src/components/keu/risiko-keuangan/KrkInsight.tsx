...
import { krkInsights } from "@/lib/krk-data";

const STYLES = [
  { bg: "bg-[#fdf3e0]", icon: "text-[#d98b06]", Icon: Scale },
  { bg: "bg-[#fdecec]", icon: "text-[#ef4444]", Icon: ShieldAlert },
];

export function KrkInsight() {
  return (
    <div
