import { Activity, Banknote, Gauge, ShieldCheck, TrendingDown } from "lucide-react";
import { krkKpi } from "@/lib/krk-data";
import { Delta } from "@/components/ui/Delta";

const ICONS = [Gauge, Banknote, ShieldCheck, TrendingDown, Activity];
