...
import { kskDecisions, type KskDecision } from "@/lib/ksk-data";
...
export function KskDecisionCenter() {
  return (
    <div
    ...
    >
      ...
      <p className="mt-[3px] text-[9px] text-ink-500">
        Keputusan Berbasis Skenario yang Menunggu Persetujuan BOD
      </p>
      ...
      <button className="mt-auto w-full rounded-lg border border-[#e3e9ef] py-[6px] text-[9.5px] font-semibold text-ink-700 transition-colors hover:bg-[#f5f8fa]">
