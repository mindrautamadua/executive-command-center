import { ArrowRight, Scale, Sparkles, TrendingDown } from "lucide-react";
import { kskInsights } from "@/lib/ksk-data";

const STYLES = [
  { bg: "bg-[#e8f1fd]", icon: "text-[#2f6fe4]", Icon: Scale },
  { bg: "bg-[#fdf3e0]", icon: "text-[#d98b06]", Icon: TrendingDown },
];

export function KskInsight() {
  return (
    <div
