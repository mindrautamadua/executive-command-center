...
export const distribusiUnderperform = [
  ...
  { label: "PTPN I Regional 1", value: 6.8, note: "489 orang" },
  { label: "PTPN IV Regional 3", value: 6.2, note: "455 orang" },
...
export const distribusiRows: DistribusiRow[] = [
  ...
  { entitas: "PTPN IV Regional 3", dinilai: 7338, outstanding: 18.2, above: 54.0, on: 21.6, below: 5.0, poor: 1.2, score: "85,6", status: "Sehat" },
  { entitas: "PTPN I Regional 1", dinilai: 7191, outstanding: 17.4, above: 53.1, on: 22.7, below: 5.5, poor: 1.3, score: "84,3", status: "Perlu Kalibrasi" },
...
export const trenDelta = [
  ...
  { label: "PTPN IV Regional 3", value: 12.1, note: "73,5 → 85,6" },
  { label: "PTPN I Regional 3", value: 11.6, note: "76,2 → 87,8" },
  { label: "PTPN IV Regional 2", value: 10.8, note: "72,9 → 83,7" },
  { label: "PTPN I Regional 1", value: 10.2, note: "74,1 → 84,3" },
...
export const dimensiRows: DimensiRow[] = [
  ...
  { dimensi: "Inovasi & Improvement", bobot: "10%", q2: "81,6", q1: "78,7", delta: "+2,9", tertinggi: "PTPN Holding (87,1)", terendah: "PTPN I Regional 1 (74,8)", status: "Perlu Fokus" },
...
export const unitRows: UnitRow[] = [
  ...
  { unit: "PTPN IV Regional 3", karyawan: 7338, score: "85,6", delta: "+12,1", outstanding: "18,2%", below: "6,2%", pencapaian: "78,2%", kalibrasi: "Selesai", status: "Di atas target" },
  { unit: "PTPN I Regional 1", karyawan: 7191, score: "84,3", delta: "+10,2", outstanding: "17,4%", below: "6,8%", pencapaian: "76,9%", kalibrasi: "Berjalan", status: "Mendekati target" },
