/**
 * Data statis layer intelligence halaman Industrial Relations
 * (/industrial-relations) — melengkapi ir-data.ts (monitoring dasar).
...
import type { RiskLevel } from "./ir-data";
...
export const strikeWatch: StrikeWatchRow[] = [
...
export interface ComplianceIntelRow {
  name: string;
  pct: number;
  target: number;
...
export const complianceIntel: ComplianceIntelRow[] = [
...
export const regionHeatmap: RegionHeatRow[] = [
...
/* ── Top isu 12 bulan (basis 170 kasus, rekonsiliasi) ─────────────── */

export const irIssues12m = [
...
export const irAiHeadline = {
  ...
  body: "IR Index 76,4 (terendah), strike risk Tinggi, compliance 85%. Sinyal kontributor: kasus belum terselesaikan menumpuk, kepatuhan PKB rendah, dan frekuensi perselisihan meningkat. Bah Jambi & Sei Mangkei tetap dipantau terpisah sebagai lokasi eskalasi.",
};
